	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><?echo $prop['HEAD']?></li>
			</ol>
		</div>
	</div>
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array(0=>$prop["TITLE"],1=>$prop["ANNOTATION"],2=>"AUTHORS",3=>"PUBLTYPE",4=>"JOURNAL",5=>$prop["BIBLIODATA"],6=>"isOMI",7=>"FULLTEXT",8=>"UDK",9=>"KEYWORDS",10=>"PUBLDATE",11=>"",),
		...
		"LIST_PROPERTY_CODE" => array(0=>$prop["TITLE"],1=>$prop["ANNOTATION"],2=>"AUTHORS",3=>"PUBLTYPE",4=>"JOURNAL",5=>"PUBLDATE",6=>"",),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "10",
